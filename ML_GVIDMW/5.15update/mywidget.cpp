...
#include "mywidget.h"
extern short minisrconppi1[2];
extern short minisrconppi2[2];
...
if(VideoChannel==0)
{
    minisrconppi1[0]=x;minisrconppi1[1]=y;//add by shen ,to save the mini location on ppi
}
else
{
    minisrconppi2[0]=x;minisrconppi2[1]=y;//add by shen ,to save the mini location on ppi
}
bshowminionppi=bshowmarkonPPI&&bshowminionppi;//是否在PPI上绘制mini win的窗口位置
