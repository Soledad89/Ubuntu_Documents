...
#include <stdio.h>
#include "ppidef.h"
extern short scanMode[2];
extern bool bHmode[2];
/*
extern s_ppi_video_for_disp * dispbuf1;
extern s_ppi_video_for_disp * dispbuf2;
extern s_ppi_video_for_disp *dispbufnet1;//=new s_ppi_video_for_disp[50];//global variant
extern s_ppi_video_for_disp *dispbufnet2;//=new s_ppi_video_for_disp[50];//global variant

extern FILE * rpkgfp;
extern FILE * hpkgfp;
extern bool radarOpenState[2];
extern bool TVopenState[2];
extern bool blocal;
extern bool PPItogether;
extern qint32 aziLine[2];
extern bool checkini;
extern bool checkradardata;
extern bool isOK;
...
//*****************************************************//
class GVIDMW_API thu_gvidwidget : public QWidget//,public  QObject
{
    Q_OBJECT
...
public:
    ...
    void closeyh(char VideoChannel){pmywidget[VideoChannel]->yh->bYh=false;}
    void openyh(char VideoChannel){pmywidget[VideoChannel]->yh->bYh=true;}
...
//------------MINI---------------------------------------------------------
    void setminiwinmode(char VideoChannel,short theMode){bool bhmode=bHmode[VideoChannel];pmywidget[VideoChannel]->ML_GVID_SetPPIMode(-1,VideoChannel,theMode,bhmode);}
...
//-----------Radar----------------------------------------------------------
    ...
    int getnorthIdex(char VideoChannel){return pmywidget[VideoChannel]->ppi->getnorthIndex();}
    int ML_GVID_SendRadarPkg(char VideoChannel, int pkgNum, ML_GVIDMW_RadarPkg_t *pkgBuf,bool bhmode);
